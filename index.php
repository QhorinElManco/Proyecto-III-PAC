...
<body>
  ...
  <section class="container-fluid" style=" display:flex; background-image: url(img/unah.jpeg);background-repeat: no-repeat;background-size: cover; max-width: 1341px; height:auto">
    ...
    <section class="col-xl-8 col-sm-8">
      ...
      <div id="carouselExampleIndicators" class="carousel slide col-xl-10 col-sm-10" style="max-height:320px margin-left:20px;" data-ride="carousel">
        ...
        <div class="carousel-inner" style="background-size:cover; margin:auto">
          ...
          <div class="carousel-item" style="background-color: rgba(0, 0, 0, 0.6)">
            <img class="d-block " src="img/unah-curno.jpg" style="max-width:100%; max-height:330px; background-size:cover; margin:auto"
              alt="Sixth slide">
          </div>
      ...
      <div style="display:flex">
        <section style="width:260px;height:180px; background-color: rgb(1, 49, 94); margin:10px; margin-left:16%; background-size:cover">
          <a href="http://www.admisiones.unah.edu.hn/Portals/0/calendarioA2018.png"><img style="width:100%" src="img/Calendarioacademico2018.jpg"
              alt="Calendario 2018"></a>
        </section>
        <section style="width:270px;height:180px; background-color: rgb(1, 49, 94); margin:10px; background-image: url(); background-size:cover;">
          <a href=" http://www.admisiones.unah.edu.hn/Portals/0/ALFABETICO%203ER%20PROCESO-%20Lunes%206.jpg"><img style="width:92%; margin-top:18px; margin-left: 10px"
              src="img/boton-calendario-alfabetico2018.jpg" alt="Calendario entrega de documentos"></a>
        </section>
      </div>
      <br>
      <hr>
      ...
      <div class="accordion" id="accordionExample">
        ...
        <div class="card" style="border: 2px solid rgb(1, 49, 94); padding: 10px;background-color:white;">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              <a href="https://registro.unah.edu.hn/images/avisoRecepcionDocumentos.jpeg">Creacion de expedientes
                estudiantiles</a><br>
              <a href="https://registro.unah.edu.hn/images/CALENDARIORECEPCION2019.jpg">Calendario de recepcion de
                documentos</a><br>
    ...
    <section style="background-color: rgba(0, 0, 0, 0.6); display:block; height:auto; margin-left:17px;" class="col-xl-4"><br>
      <br>
      <div> <img src="img/puma.jpg" alt="" class="col-12" style=" height:180px"></div><br><br>
      ...
      <div class="clearfix" style="margin:auto">
        <h4 class="mb-1 ls1 t700" style="color:white; margin:5px"> redes sociales </h4>
  ...
  <footer class="footer" style="margin-right: 0px; margin-left: auto; background-color: rgb(1, 49, 94); height:150px;">
    <div style="margin:auto; text-align: center; padding:auto; ">
      <a href="https://www.unah.edu.hn/?cat=1477&fcats" style="color:white; margin-top:20px;">Dirección Ejecutiva de
        Gestión de Tecnología (DEGT)</a>
      <hr style="background-color:white; margin: 15px">
      <p style="text-align:center;margin:20px; color:white">Bulevar Suyapa, Tegucigalpa, M.D.C, Honduras, Centroamérica<br>
        info@unah.edu.hn <br>

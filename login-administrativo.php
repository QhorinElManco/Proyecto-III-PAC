        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="container" id="login">
                    <h6>Para acceder a los servicios ingresa numero de empleado y clave</h6>
                    <div class="card card-container">
                        <img id="profile-img" class="profile-img-card" src="img/profesor.png">
                        <p id="profile-name" class="profile-name-card"></p>
                        <form class="form-signin">
                                <span id="reauth-email" class="reauth-email"></span>
                                <input class="form-control" type="text" id="idEmpleado" placeholder="ID de empleado" required autofocus><br>
                                ...
                                <select class="form-control" id="slc-usuario" required autofocus>
                                    ...
                                    <option value="1">Dirección académica</option>
                                    <option value="2">DIPP</option>
                                </select>
                                <br>
